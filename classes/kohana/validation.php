...
class Kohana_Validation extends ArrayObject {
	...
	protected $_empty_rules = array('not_empty', 'matches', 'min_length', 'valid::not_empty', 'valid::matches', 'valid::min_length');
	...
	public function check()
	{
		...
		foreach ($rules as $field => $set)
		{
			...
			foreach ($set as $array)
			{
				...
				if ( ! in_array(strtolower($rule), $this->_empty_rules) AND ! Valid::not_empty($value))
					continue;
