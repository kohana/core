...
<div class="kohana">
	...
	<table class="profiler">
		<tr class="group">
			<th class="name" rowspan="2"><?php echo __(ucfirst($group), NULL, 'en-us') ?></th>
		...
		<tr class="headers">
			<th class="name"><?php echo __('Benchmark', NULL, 'en-us') ?></th>
			<?php foreach ($group_cols as $key): ?>
			<th class="<?php echo $key ?>"><?php echo __(ucfirst($key), NULL, 'en-us') ?></th>
			<?php endforeach ?>
		</tr>
	...
	<table class="profiler">
		...
		<tr class="final mark time">
			<th class="name" rowspan="2" scope="rowgroup"><?php echo __('Application Execution', NULL, 'en-us').' ('.$stats['count'].')' ?></th>
